...
void
LedIndicator::switchLedIndicator() {
    lit = ! lit;
    repaint();
}
...
void
LedIndicator::setState(bool state) {
    lit = state;
    repaint();
}
...
void
LedIndicator::setOnColor(QColor onColor) {
    ledOnColor=onColor;
    repaint();
}
...
void
LedIndicator::setOffColor(QColor offColor) {
...
void
LedIndicator::setOnPattern(Qt::BrushStyle onPattern) {
...
void
LedIndicator::setOffPattern(Qt::BrushStyle offPattern) {
...
void
LedIndicator::setLedSize(int size) {
    ledSize=size;
